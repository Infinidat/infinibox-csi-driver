...
# Original source:
# https://kubernetes.slack.com/archives/C8EJ01Z46/p1618923412132600?thread_ts=1618524377.095000&cid=C8EJ01Z46
#	- Discussion.
# https://github.com/kubernetes-csi/csi-release-tools/blob/master/go-get-kubernetes.sh
#	- Master at the time, broken. Quits if an error is hit wo writing the remainder.
# https://github.com/jsafrane/csi-release-tools/blob/c1078a6585735bfcad4d273dee57860544d6fd2a/go-get-kubernetes.sh
#	- Older, but working. This is the version copied here.
