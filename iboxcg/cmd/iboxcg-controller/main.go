...
import (
	...
	csidriverv1 "github.com/infinidat/infinibox-csi-driver/iboxcg/api/v1"
	"github.com/infinidat/infinibox-csi-driver/iboxcg/internal/controller"
...
func init() {
	...
	utilruntime.Must(csidriverv1.AddToScheme(scheme))
...
func main() {
	...
	flag.StringVar(&probeAddr, "health-probe-bind-address", ":8090", "The address the probe endpoint binds to.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "afeefbf7.infinidat.com",
	...
	if err = (&controller.IboxcgReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Iboxcg")
		os.Exit(1)
	}
