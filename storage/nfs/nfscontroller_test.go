...
func (suite *NFSControllerSuite) Test_CreateVolume_FileNameExist_exportError() {
	...
	suite.iboxapi.On("GetSystem", mock.Anything).Return(storagecommon.GetSystem(), nil)
	suite.iboxapi.On("GetNetworkSpaceByName", mock.Anything).Return(storagecommon.GetNetworkSpace(), nil)
	suite.iboxapi.On("GetFileSystemByName", mock.Anything).Return(storagecommon.GetFileSystem(), nil)
	suite.iboxapi.On("GetExportsByFileSystemID", mock.Anything).Return(storagecommon.GetExportPath(), suite.someError)
...
func (suite *NFSControllerSuite) Test_CreateVolume_FileNameExist_sucess() {
	...
	suite.iboxapi.On("GetSystem", mock.Anything).Return(storagecommon.GetSystem(), nil)
	suite.iboxapi.On("GetNetworkSpaceByName", mock.Anything).Return(storagecommon.GetNetworkSpace(), nil)
	suite.iboxapi.On("GetFileSystemByName", mock.Anything).Return(storagecommon.GetFileSystemPrior(), nil)
	suite.iboxapi.On("GetExportsByFileSystemID", mock.Anything).Return(storagecommon.GetExportPath(), nil)
...
func (suite *NFSControllerSuite) Test_CreateVolume_success() {
	...
	suite.iboxapi.On("CreateFileSystem", mock.Anything).Return(storagecommon.GetFileSystemPrior(), nil)
	suite.iboxapi.On("GetExportsByFileSystemID", mock.Anything).Return(storagecommon.GetExportPath(), nil)
