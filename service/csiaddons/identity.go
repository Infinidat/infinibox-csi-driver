...
func (is *IdentityServer) GetCapabilities(
	...
	slog.Debug("csiaddons IdentityServer", "GetCapabilities", "started")
...
func (is *IdentityServer) Probe(
	...
	slog.Debug("csiaddons IdentityServer", "Probe", "started")
